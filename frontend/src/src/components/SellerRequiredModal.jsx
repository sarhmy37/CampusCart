    ...
    return (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
            ...
            <div className="relative bg-white dark:bg-ink-800 border border-transparent dark:border-ink-600 rounded-2xl shadow-2xl max-w-sm w-full p-6">
                ...
                <div className="w-11 h-11 rounded-xl bg-brand-50 dark:bg-brand-900 text-brand-600 dark:text-brand-400 flex items-center justify-center mb-4">
                    <Store size={20} />
                </div>
                <h3 className="font-bold text-slate-900 dark:text-brand-50 text-lg">Seller account required</h3>
                ...
                <div className="flex gap-2 mt-6">
                    <button
                        onClick={onClose}
                        className="flex-1 py-2.5 rounded-xl border border-slate-200 dark:border-ink-600 text-slate-600 dark:text-brand-200 hover:bg-slate-50 dark:hover:bg-ink-700 text-sm font-semibold transition"
                    >
                        Cancel
                    </button>
                    <button
                        onClick={() => { onClose(); navigate('/register?role=seller'); }}
                        className="flex-1 py-2.5 rounded-xl bg-brand-600 dark:bg-brand-500 hover:bg-brand-700 dark:hover:bg-brand-400 text-white dark:text-ink-900 text-sm font-semibold transition"
                    >
                        Sign up as Seller
                    </button>
                </div>
