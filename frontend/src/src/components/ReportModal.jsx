    ...
    return (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
            ...
            <div className="relative bg-white dark:bg-ink-800 border border-transparent dark:border-ink-600 rounded-2xl shadow-2xl max-w-sm w-full p-6 animate-in fade-in zoom-in duration-150">
                ...
                <h3 className="font-bold text-slate-900 dark:text-brand-50 text-lg">Report this listing</h3>
                ...
                <div className="mt-5 space-y-3">
                    <div>
                        <label className="text-xs font-semibold text-slate-500 dark:text-brand-200/60">Reason</label>
                        <select
                            value={reason}
