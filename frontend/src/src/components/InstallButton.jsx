    ...
    return (
        <>
            ...
            <button
                ...
                className="fixed bottom-6 right-6 z-50 flex items-center gap-2 bg-brand-600 hover:bg-brand-700 dark:bg-brand-500 dark:hover:bg-brand-400 text-white dark:text-ink-900 px-4 py-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 group"
            ...
            {showModal && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center px-4">
                    ...
                    <div className="relative bg-white dark:bg-ink-800 rounded-2xl shadow-2xl w-full max-w-sm p-6 border border-slate-200 dark:border-ink-600">
                        <button
                            onClick={() => setShowModal(false)}
                            className="absolute top-3 right-3 p-1.5 rounded-lg hover:bg-slate-100 dark:hover:bg-ink-700 text-slate-400 dark:text-brand-300/50 transition"
                        >
                            <X size={18} />
                        </button>

                        <div className="flex items-center gap-3 mb-4">
                            <div className="w-12 h-12 rounded-xl bg-brand-50 dark:bg-brand-900 flex items-center justify-center shrink-0">
                                <Smartphone className="text-brand-600 dark:text-brand-400" size={24} />
                            </div>
                            <div>
                                <h3 className="text-lg font-extrabold text-slate-900 dark:text-brand-50">
                                    Install Tre-X
                                </h3>
                        ...
                        <ul className="space-y-2.5 text-sm text-slate-600 dark:text-brand-200/70 mb-6">
                        ...
                        <button
                            ...
                            className="w-full py-3 rounded-xl bg-brand-600 dark:bg-brand-500 hover:bg-brand-700 dark:hover:bg-brand-400 text-white dark:text-ink-900 font-semibold text-sm transition disabled:opacity-60 flex items-center justify-center gap-2"
                        >
                            {installing ? (
                                <>
                        ...
                        <button
                            onClick={() => setShowModal(false)}
                            className="w-full mt-2 py-2 text-xs text-slate-400 dark:text-brand-200/40 hover:text-slate-600 dark:hover:text-brand-100 transition"
                        >
                            Maybe later
                        </button>
                    </div>
