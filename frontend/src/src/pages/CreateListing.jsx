...
export default function CreateListing() {
    ...
    return (
        <div className="min-h-[calc(100vh-64px)] grid lg:grid-cols-2 relative overflow-hidden">
            ...
            <div className="absolute top-0 left-0 right-0 h-[38vh] lg:hidden overflow-hidden bg-gradient-to-br from-brand-900 via-brand-800 to-accent-600 dark:from-ink-900 dark:via-ink-900 dark:to-brand-900">
            ...
            <div className="relative hidden lg:block overflow-hidden">
                ...
                <div className="absolute left-1/4 -bottom-24 w-64 h-64 bg-accent-500/20 dark:bg-brand-500/10 rounded-full blur-3xl" />
            ...
            <div className="relative z-10 flex items-center justify-center px-4 pt-[24vh] pb-16 lg:pt-16 lg:pb-16 bg-transparent lg:bg-slate-50 dark:lg:bg-ink-900">                <div className="w-full max-w-sm">
                    <div className="bg-white/90 dark:bg-ink-800/90 backdrop-blur-sm lg:bg-transparent lg:dark:bg-transparent border border-slate-200/70 dark:border-ink-600/70 lg:border-0 rounded-3xl lg:rounded-none p-6 sm:p-7 lg:p-0 shadow-[0_1px_2px_rgba(15,23,42,0.04),0_12px_32px_-16px_rgba(15,23,42,0.12)] lg:shadow-none">
                        <h1 className="text-2xl font-extrabold text-slate-900 dark:text-brand-50">New Listing</h1>
                        <p className="text-sm text-slate-500 dark:text-brand-200/50 mt-1">Add the details buyers will see.</p>

                        <form onSubmit={onSubmit} className="mt-5 space-y-4">
                            <div>
                                <label className="text-sm font-semibold text-slate-700 dark:text-brand-200">Title</label>
                                <input
                                    required
                                    value={form.title}
                                    onChange={(e) => setForm({ ...form, title: e.target.value })}
                                    placeholder="e.g. Casio scientific calculator"
                                    className="w-full mt-1 px-4 py-2.5 rounded-xl border border-slate-200 dark:border-ink-600 dark:bg-ink-800 dark:text-brand-50 dark:placeholder-brand-300/30 focus:border-brand-500 dark:focus:border-brand-500 focus:ring-2 focus:ring-brand-100 dark:focus:ring-brand-900 focus:outline-none text-sm bg-white transition"
                                />
                            </div>

                            <div>
                                <label className="text-sm font-semibold text-slate-700 dark:text-brand-200">Description</label>
                                <textarea
                                    rows={3}
                                    value={form.description}
                                    onChange={(e) => setForm({ ...form, description: e.target.value })}
                                    placeholder="Condition, why you're selling, anything a buyer should know"
                                    className="w-full mt-1 px-3 py-2.5 rounded-xl border border-slate-200 dark:border-ink-600 dark:bg-ink-800 dark:text-brand-50 dark:placeholder-brand-300/30 focus:border-brand-500 dark:focus:border-brand-500 focus:ring-2 focus:ring-brand-100 dark:focus:ring-brand-900 focus:outline-none text-sm bg-white transition resize-none"
                                />
                            </div>

                            <div className="grid grid-cols-2 gap-3">
                                <div>
                                    <label className="text-sm font-semibold text-slate-700 dark:text-brand-200">Photos</label>
                                    <div className="grid grid-cols-3 gap-1.5 mt-1 w-full">
                                        ...
                                        {imageUrls.length < MAX_IMAGES && !uploading && (
                                            <button
                                                ...
                                                className="aspect-square rounded-xl border border-dashed border-slate-300 dark:border-ink-500 flex flex-col items-center justify-center gap-1 text-slate-400 dark:text-brand-300/40 hover:border-brand-400 dark:hover:border-brand-500 hover:text-brand-500 dark:hover:text-brand-400 cursor-pointer transition"
                                            >
                                                <ImagePlus size={20} />
                                    ...
                                    <p className="text-xs text-slate-400 dark:text-brand-200/40 mt-1.5">Up to {MAX_IMAGES}. First is cover.</p>
                                ...
                                <div>
                                    <label className="text-sm font-semibold text-slate-700 dark:text-brand-200">Video</label>
                                    ...
                                    <p className="text-xs text-slate-400 dark:text-brand-200/40 mt-1.5">Optional. Up to 20MB.</p>
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <div>
                                    <label className="text-sm font-semibold text-slate-700 dark:text-brand-200">Price (GHS)</label>
                                    <input
                                        required
                                        type="number"
                                        min="0"
                                        ...
                                        className="w-full mt-1 px-4 py-2.5 rounded-xl border border-slate-200 dark:border-ink-600 dark:bg-ink-800 dark:text-brand-50 focus:border-brand-500 dark:focus:border-brand-500 focus:ring-2 focus:ring-brand-100 dark:focus:ring-brand-900 focus:outline-none text-sm bg-white transition"
                                    />
                                </div>
                                <div>
                                    <label className="text-sm font-semibold text-slate-700 dark:text-brand-200">Stock</label>
                                    <input
                                        type="number"
                                        min="1"
                                        value={form.stock}
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <div>
                                    <label className="text-sm font-semibold text-slate-700 dark:text-brand-200">Category</label>
                                    <select
                                        value={form.category_id}
                                        onChange={(e) => setForm({ ...form, category_id: e.target.value })}
                                        className="w-full mt-1 px-4 py-2.5 rounded-xl border border-slate-200 dark:border-ink-600 dark:bg-ink-800 dark:text-brand-50 focus:border-brand-500 dark:focus:border-brand-500 focus:ring-2 focus:ring-brand-100 dark:focus:ring-brand-900 focus:outline-none text-sm bg-white transition appearance-none"
                                    >
                                ...
                                <div>
                                    <label className="text-sm font-semibold text-slate-700 dark:text-brand-200">Condition</label>
                                    <select
                            ...
                            <div className="border-t border-slate-100 dark:border-ink-600 pt-4">
                                <div className="flex items-center gap-2 mb-1">
                                    <Truck size={15} className="text-slate-500 dark:text-brand-300/60" />
                                    <label className="text-sm font-semibold text-slate-700 dark:text-brand-200">Delivery pricing</label>
                                </div>
                                ...
                                <div className="grid grid-cols-3 gap-2">
                                    <div>
                                        <label className="text-[11px] font-semibold text-slate-500 dark:text-brand-200/60">On campus</label>
                                        <input
                                            type="number"
                                            min="0"
                                            ...
                                            placeholder="0"
                                            className="w-full mt-1 px-2.5 py-2 rounded-lg border border-slate-200 dark:border-ink-600 dark:bg-ink-800 dark:text-brand-50 focus:border-brand-500 dark:focus:border-brand-500 focus:ring-2 focus:ring-brand-100 dark:focus:ring-brand-900 focus:outline-none text-sm bg-white transition"
                                        />
                                    </div>
                                    <div>
                                        <label className="text-[11px] font-semibold text-slate-500 dark:text-brand-200/60">Just outside</label>
                                        <input
                                            type="number"
                                            min="0"
                                            max={MAX_DELIVERY_FEE}
                                    ...
                                    <div>
                                        <label className="text-[11px] font-semibold text-slate-500 dark:text-brand-200/60">Far</label>
                                        <input
                                            type="number"
                                            min="0"
                                            max={MAX_DELIVERY_FEE}
            ...
            {showDeliveryWarning && (
                <div className="fixed inset-0 z-[120] flex items-end sm:items-center justify-center">
                    ...
                    <div className="relative w-full sm:max-w-sm bg-white dark:bg-ink-800 rounded-t-2xl sm:rounded-2xl shadow-2xl p-5 sm:p-6">
                        ...
                        <h3 className="font-bold text-slate-900 dark:text-brand-50 text-base">
                            Delivery fees can affect sales
                        </h3>
                        <p className="text-sm text-slate-500 dark:text-brand-200/60 mt-2">
                        ...
                        <div className="flex flex-col gap-2 mt-5">
                            ...
                            <button
                                ...
                                disabled={loading}
                                className="w-full py-2.5 rounded-xl border border-slate-200 dark:border-ink-600 text-slate-700 dark:text-brand-200 font-semibold text-sm transition hover:bg-slate-50 dark:hover:bg-ink-700"
                            >
