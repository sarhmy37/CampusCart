    ...
    return (
        <div>
            <section className="relative overflow-hidden">
                ...
                <div className="absolute left-1/3 -bottom-20 w-56 h-56 bg-brand-300/20 dark:bg-brand-500/10 rounded-full blur-3xl" />
            ...
            <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8 space-y-5">
                ...
                {isSeller && (
                    <div className="bg-white dark:bg-ink-800 border border-slate-200 dark:border-ink-600 rounded-2xl overflow-hidden shadow-sm">
                        <div className="relative overflow-hidden bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-ink-900 dark:via-ink-800 dark:to-brand-900 p-6">
                            {user?.avatar_url && (
                                <div
                                    className="absolute -right-12 top-1/2 -translate-y-1/2 w-80 h-80 pointer-events-none"
                                    style={{
                            ...
                            <div className="absolute inset-0 bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-ink-900 dark:via-ink-800 dark:to-brand-900 opacity-0 dark:opacity-40 pointer-events-none" />
                        ...
                        <div className="p-6">
                            <div className="flex items-center gap-2.5 mb-4">
                                ...
                                <div>
                                    <h2 className="font-bold text-slate-900 dark:text-brand-50">Business Profile</h2>
                            ...
                            <div className="flex items-center gap-2">
                                <input
                                    ...
                                    className="flex-1 px-3 py-2.5 rounded-xl border border-slate-200 dark:border-ink-600 dark:bg-ink-700 dark:text-brand-50 text-sm truncate"
                                />
                                <button
                                    onClick={copyBusinessLink}
                                    className="shrink-0 p-2.5 rounded-xl bg-slate-100 dark:bg-ink-600 text-slate-600 dark:text-brand-200 hover:bg-slate-200 dark:hover:bg-ink-500 transition"
                                    title="Copy link"
                                >
                                    <Copy size={16} />
                                </button>
                            ...
                            <div className="mt-4">
                                <div className="flex items-center justify-between mb-2.5">
                                    <span className="text-xs font-semibold text-slate-500 dark:text-brand-200/60">Share on:</span>
                                    <button
                                        onClick={() => setShowStorePreview(true)}
                                        className="text-xs font-semibold text-brand-600 dark:text-brand-400 hover:text-brand-700 dark:hover:text-brand-300 transition"
                                    >
                                        Preview →
                                    </button>
                                </div>
                                ...
                                <button
                                    ...
                                    className="p-2 rounded-lg bg-slate-100 dark:bg-ink-600 hover:bg-slate-200 dark:hover:bg-ink-500 text-slate-500 dark:text-brand-200 transition"
                ...
                <div className="bg-white dark:bg-ink-800 border border-slate-200 dark:border-ink-600 rounded-2xl p-6 shadow-sm">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2.5">
                            ...
                            <div>
                                <h2 className="font-bold text-slate-900 dark:text-brand-50">Appearance</h2>
                                <p className="text-xs text-slate-400 dark:text-brand-200/50 mt-0.5">
                ...
                {isSeller && (
                    <div className="bg-white dark:bg-ink-800 border border-slate-200 dark:border-ink-600 rounded-2xl overflow-hidden shadow-sm">
                        ...
                        >
                            <div className="flex items-center gap-2.5">
                                <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-brand-600 to-accent-500 dark:from-brand-600 dark:to-brand-400 text-white flex items-center justify-center">
                                    <Percent size={16} />
                                </div>
                                <div className="text-left">
                                    <h2 className="font-bold text-slate-900 dark:text-brand-50">Fees & Terms</h2>
                                    <p className="text-xs text-slate-400 dark:text-brand-200/50 mt-0.5">Platform commission for sellers</p>
                                </div>
                            </div>
                            <ChevronDown size={18} className={`text-slate-400 dark:text-brand-300/60 transition-transform ${termsOpen ? 'rotate-180' : ''}`} />
                        </button>

                        {termsOpen && (
                            <div className="px-6 pb-6 -mt-1">
                                <div className="bg-brand-50 dark:bg-ink-700 border border-brand-100 dark:border-brand-800 rounded-xl p-4">
                                ...
                                <ul className="mt-4 space-y-2.5 text-sm text-slate-600 dark:text-brand-200/70">
                                ...
                                <button
                                    ...
                                    className="inline-flex items-center gap-1 mt-4 text-sm font-semibold text-brand-600 dark:text-brand-400 hover:text-brand-700 dark:hover:text-brand-300"
                                >
                                ...
                                {fullTermsOpen && (
                                    <div className="mt-4 pt-4 border-t border-slate-100 dark:border-ink-600 space-y-4 text-sm text-slate-600 dark:text-brand-200/70">
                    ...
                    <div className="bg-white dark:bg-ink-800 border border-slate-200 dark:border-ink-600 rounded-2xl overflow-hidden shadow-sm">
                        ...
                        >
                            <div className="flex items-center gap-2.5">
                                ...
                                <div className="text-left">
                                    <h2 className="font-bold text-slate-900 dark:text-brand-50">Buyer Terms of Service</h2>
                                    <p className="text-xs text-slate-400 dark:text-brand-200/50 mt-0.5">Your shopping rights and protections</p>
                                </div>
                            </div>
                            <ChevronDown size={18} className={`text-slate-400 dark:text-brand-300/60 transition-transform ${termsOpen ? 'rotate-180' : ''}`} />
                        </button>
                        ...
                        {termsOpen && (
                            <div className="px-6 pb-6 -mt-1">
                                <ul className="space-y-2.5 text-sm text-slate-600 dark:text-brand-200/70">
                                    <li className="flex gap-2">
                                        <span className="text-brand-600 dark:text-brand-400 font-bold">•</span>
                ...
                <div className="bg-white dark:bg-ink-800 border border-slate-200 dark:border-ink-600 rounded-2xl p-6 shadow-sm">
                    <div className="flex items-center gap-2.5 mb-4">
                        ...
                        <h2 className="font-bold text-slate-900 dark:text-brand-50">Change password</h2>
                    </div>
                   ...
                   {pwStep === 1 ? (
                        <form onSubmit={requestPasswordCode} className="space-y-3">
                            ...
                            <input
                                ...
                                className="w-full px-4 py-2.5 rounded-xl border border-slate-200 dark:border-ink-600 dark:bg-ink-700 dark:text-brand-50 focus:border-brand-500 dark:focus:border-brand-500 focus:ring-2 focus:ring-brand-100 dark:focus:ring-brand-900 focus:outline-none text-sm transition"
                            />
                            <button
                                type="button"
                                onClick={() => setShow((s) => !s)}
                                className="flex items-center gap-1.5 text-xs text-slate-500 dark:text-brand-300/60 hover:text-slate-700 dark:hover:text-brand-200"
                            >
                            ...
                            <button
                                type="submit"
                                disabled={saving}
                                className="w-full py-2.5 rounded-xl bg-gradient-to-r from-brand-600 to-accent-500 dark:from-brand-600 dark:to-brand-400 hover:opacity-90 text-white dark:text-ink-900 font-semibold text-sm transition disabled:opacity-60 shadow-sm"
                            >
                        ...
                        <form onSubmit={confirmPasswordChange} className="space-y-3">
                            ...
                            <input
                                ...
                                className="w-full px-4 py-2.5 rounded-xl border border-slate-200 dark:border-ink-600 dark:bg-ink-700 dark:text-brand-50 focus:border-brand-500 dark:focus:border-brand-500 focus:ring-2 focus:ring-brand-100 dark:focus:ring-brand-900 focus:outline-none text-sm transition tracking-widest text-center font-semibold"
                            />
                            <input
                                type={show ? 'text' : 'password'}
                                required
                            ...
                            <button
                                type="button"
                                onClick={() => setPwStep(1)}
                                className="w-full text-xs text-slate-400 dark:text-brand-300/50 hover:text-slate-600 dark:hover:text-brand-200"
                            >
                                ← Start over
                            </button>
                        </form>
                ...
                <div className="bg-white dark:bg-ink-800 border border-slate-200 dark:border-ink-600 rounded-2xl p-6 shadow-sm">
                    <div className="flex items-center gap-2.5 mb-1">
                        ...
                        <div>
                            <h2 className="font-bold text-slate-900 dark:text-brand-50">Delivery preference</h2>
                            <p className="text-xs text-slate-400 dark:text-brand-200/50 mt-0.5">
                    ...
                    <div className="pt-3 border-t border-slate-100 dark:border-ink-600">
                        ...
                        <div className="flex items-center gap-2 mt-1.5">
                            <div className="relative flex-1">
                                <MapPin size={15} className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 dark:text-brand-200/40" />
                                <input
                                    type="text"
                                    value={deliveryLocation}
                                    onChange={(e) => setDeliveryLocation(e.target.value)}
                                    placeholder="e.g. near Ayeduase Gate, West End Hostel"
                                    className="w-full pl-9 pr-3 py-2.5 rounded-xl border border-slate-200 dark:border-ink-600 dark:bg-ink-700 dark:text-brand-50 focus:border-brand-500 dark:focus:border-brand-500 focus:ring-2 focus:ring-brand-100 dark:focus:ring-brand-900 focus:outline-none text-sm transition"
                                />
                            </div>
                            <button
                                onClick={saveDeliveryLocation}
                                disabled={savingLocation || !deliveryLocation.trim() || deliveryLocation.trim() === (user?.location || '').trim()}
                                className="shrink-0 flex items-center gap-1.5 px-4 py-2.5 rounded-xl bg-brand-600 dark:bg-brand-500 hover:bg-brand-700 dark:hover:bg-brand-400 text-white dark:text-ink-900 text-sm font-semibold transition disabled:opacity-50"
                            >
                                {savingLocation ? 'Saving…' : locationSaved ? <><Check size={14} /> Saved</> : 'Save'}
                            </button>
                        </div>
                        <p className="text-[11px] text-slate-400 dark:text-brand-200/40 mt-1.5">
                ...
                <div className="bg-white dark:bg-ink-800 border border-slate-200 dark:border-ink-600 rounded-2xl p-6 shadow-sm">
                    <div className="flex items-center gap-2.5 mb-4">
                        ...
                        <h2 className="font-bold text-slate-900 dark:text-brand-50">Notifications</h2>
                    </div>
                    ...
                    <div className="flex items-center justify-between py-3 border-t border-slate-100 dark:border-ink-600 first:border-0 first:pt-0">
                        <div>
                            <p className="text-sm font-semibold text-slate-800 dark:text-brand-100">New listings</p>
                            <p className="text-xs text-slate-400 dark:text-brand-200/50 mt-0.5">Get notified when new items match your interests</p>
                        </div>
                        <button
                    ...
                    <div className="flex items-center justify-between py-3 border-t border-slate-100 dark:border-ink-600 first:border-0 first:pt-0">
                        <div>
                            <p className="text-sm font-semibold text-slate-800 dark:text-brand-100">Messages</p>
                            <p className="text-xs text-slate-400 dark:text-brand-200/50 mt-0.5">Get notified when a buyer or seller messages you</p>
                        </div>
                        <button
                ...
                <div className="bg-white dark:bg-ink-800 border border-slate-200 dark:border-ink-600 rounded-2xl p-6 shadow-sm">
                    <div className="flex items-center gap-2.5 mb-1">
                        ...
                        <h2 className="font-bold text-slate-900 dark:text-brand-50">Refer a friend</h2>
                    </div>
                   <p className="text-xs text-slate-400 dark:text-brand-200/50 mb-4">
                  ...
                  <div className="flex items-center gap-2">
                        ...
                        <button
                            ...
                            className="shrink-0 px-4 py-2.5 rounded-xl bg-brand-600 dark:bg-brand-500 hover:bg-brand-700 dark:hover:bg-brand-400 text-white dark:text-ink-900 text-sm font-semibold transition"
                        >
                            Copy
                        </button>
                    </div>
                    ...
                    {referrals.length > 0 && (
                        <div className="mt-4 pt-4 border-t border-slate-100 dark:border-ink-600 space-y-2">
                            <p className="text-xs font-semibold text-slate-500 dark:text-brand-300/60 uppercase tracking-wide">
                                Your referrals ({referrals.length})
                            </p>
                            {referrals.map((r, i) => (
    <div key={i} className="flex items-center justify-between text-sm">
        <div>
            <span className="font-medium text-slate-700 dark:text-brand-100">{r.name}</span>
            <span className={`ml-2 text-xs font-semibold px-2 py-0.5 rounded-full ${
                r.verified
                    ? 'bg-emerald-50 dark:bg-emerald-950/40 text-emerald-700 dark:text-emerald-400'
                    : 'bg-amber-50 dark:bg-brand-900/40 text-amber-700 dark:text-brand-400'
            }`}>
            ...
            {r.verified ? `+GHS ${parseFloat(r.credit_earned).toFixed(2)}` : '—'}
                ...
                <div className="bg-white dark:bg-ink-800 border border-red-200 dark:border-red-900/50 rounded-2xl p-6 shadow-sm">
                    <div className="flex items-center gap-2.5 mb-2">
                        ...
                        <h2 className="font-bold text-slate-900 dark:text-brand-50">Danger zone</h2>
                    </div>
                    <p className="text-xs text-slate-400 dark:text-brand-200/50 mb-4">
            ...
            {deleteOpen && (
                <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
                    ...
                    <div className="relative bg-white dark:bg-ink-800 rounded-2xl shadow-2xl max-w-sm w-full p-6">
                        ...
                        <h3 className="font-bold text-slate-900 dark:text-brand-50 text-lg">Delete your account?</h3>
                        ...
                        <input
                            ...
                            className="w-full mt-4 px-4 py-2.5 rounded-xl border border-slate-200 dark:border-ink-600 dark:bg-ink-700 dark:text-brand-50 focus:border-red-400 focus:ring-2 focus:ring-red-100 dark:focus:ring-red-900 focus:outline-none text-sm transition"
                        />
    ...
    return (
        <div className="bg-white dark:bg-ink-800 border border-slate-200 dark:border-ink-600 rounded-2xl p-6 shadow-sm">
            <div className="flex items-center gap-2.5 mb-1">
                ...
                <h2 className="font-bold text-slate-900 dark:text-brand-50">Delivery Locations</h2>
            </div>
            <p className="text-xs text-slate-400 dark:text-brand-200/50 mb-4">
            ...
            {loading ? (
                ...
                <p className="text-sm text-slate-400 dark:text-brand-200/50 mb-4">No saved locations yet.</p>
            ) : (
                        ...
                        >
                            <label className="flex items-center gap-3 min-w-0 flex-1 cursor-pointer">
                                <input
                                    ...
                                    className="w-4 h-4 accent-brand-600 dark:accent-brand-500 shrink-0"
                                />
                                <div className="min-w-0">
                                    <p className="text-sm font-medium text-slate-800 dark:text-brand-100 truncate">{loc.location}</p>
                                    {loc.is_default && (
            ...
            <div className="flex items-center gap-2">
                <input
                    ...
                    className="flex-1 px-3 py-2.5 rounded-xl border border-slate-200 dark:border-ink-600 dark:bg-ink-700 dark:text-brand-50 focus:border-brand-500 dark:focus:border-brand-500 focus:ring-2 focus:ring-brand-100 dark:focus:ring-brand-900 focus:outline-none text-sm"
                />
                <button
                    onClick={handleAdd}
                    disabled={adding}
                    className="shrink-0 px-4 py-2.5 rounded-xl bg-brand-600 dark:bg-brand-500 hover:bg-brand-700 dark:hover:bg-brand-400 text-white dark:text-ink-900 text-sm font-semibold transition disabled:opacity-60"
                >
                    {adding ? 'Adding…' : 'Add'}
                </button>
            </div>
...
function TermsBlock({ title, children }) {
    return (
        <div>
            <p className="font-bold text-slate-800 dark:text-brand-100">{title}</p>
