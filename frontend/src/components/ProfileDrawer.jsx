    ...
    return (
        <>
            ...
            >
                ...
                >
                {/* Header */}
<div className="relative bg-gradient-to-br from-slate-800 via-slate-700 to-brand-600 dark:from-ink-900 dark:via-ink-800 dark:to-gold-900 px-6 pt-6 pb-16">                    <button
                        onClick={onClose}
                ...
                <div className="px-6 mt-6 pb-8 space-y-2">
                    ...
                    <button
                        ...
                        className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl bg-slate-100 dark:bg-ink-700 hover:bg-slate-50 dark:hover:bg-ink-600 text-sm font-semibold text-slate-800 dark:text-gold-100 transition"
                    >
                    ...
                    <div className="rounded-xl bg-slate-100 dark:bg-ink-700 overflow-hidden">
                        <button
                            ...
                            className="w-full flex items-center justify-between px-3 py-2.5 text-sm font-semibold text-slate-800 dark:text-gold-100 transition hover:bg-slate-50 dark:hover:bg-ink-600"
                        >
                            <div className="flex items-center gap-3">
                                <Info size={17} />
