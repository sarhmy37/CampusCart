...
<div className="absolute inset-0 bg-gradient-to-br from-ink-900/60 via-ink-800/35 to-brand-600/30 dark:from-ink-900/80 dark:via-ink-900/55 dark:to-gold-900/40" />                </div>
            ...
            {/* PRICING / SUBSCRIPTION — NOW FULLY LIGHT/DARK AWARE */}
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="h-px bg-slate-200 dark:bg-ink-700" />
            </div>

            <section className="relative overflow-hidden bg-gradient-to-b from-slate-100 via-white to-slate-100 dark:from-ink-950 dark:via-ink-900 dark:to-ink-950 py-16 sm:py-20">
                            ...
                            >
                                <div
                                    className={`relative h-full rounded-2xl p-3 sm:p-6 border backdrop-blur-sm transition ${
                                        plan.highlight
                                            ? 'bg-white border-brand-200 dark:bg-white/[0.06] dark:border-gold-500/40 shadow-lg shadow-brand-500/10'
                                ...
                                >
                                    ...
                                    <div className="flex items-end justify-center gap-1 mt-1 sm:mt-2">
                                        ...
                                        <span className="text-slate-400 dark:text-white/50 text-[10px] sm:text-sm mb-0.5 sm:mb-1">{plan.period}</span>
                                    </div>

                                    <div className="mt-3 pt-3 sm:mt-6 sm:pt-5 border-t border-slate-200 dark:border-white/10 grid grid-cols-2 gap-2 sm:gap-4">
                                        <div>
                                            <p className="text-[9px] sm:text-[11px] font-bold text-slate-400 dark:text-white/50 uppercase tracking-wide mb-1 sm:mb-2">Buyers</p>
                                        ...
                                        <div>
                                            <p className="text-[9px] sm:text-[11px] font-bold text-slate-400 dark:text-white/50 uppercase tracking-wide mb-1 sm:mb-2">Sellers</p>
                                            <ul className="space-y-1 sm:space-y-1.5">
                                    ...
                                    {(() => {
                                        ...
                                        if (isCurrent) {
                                            return (
                                                <button
                                                    disabled
                                                    className="w-full mt-3 sm:mt-6 py-1.5 sm:py-2.5 rounded-xl font-semibold text-xs sm:text-sm bg-slate-100 dark:bg-white/10 text-slate-400 dark:text-white/50 cursor-not-allowed"
                                                >
                                                    Current plan
                                                </button>
                                            );
            ...
            {/* SITE FOOTER — LANGUAGE SELECTOR NOW ON THE FAR RIGHT */}
            <footer className="bg-ink-950 border-t border-white/10 py-10">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
                        ...
                        {/* Language selector — now on the far right */}
