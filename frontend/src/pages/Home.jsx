                    ...
                    <Reveal delay={300}>
                        <div className="mt-8 flex flex-nowrap gap-2 sm:gap-3">
                            ...
                            <button
                                ...
                                className="relative overflow-hidden inline-flex items-center justify-center w-[130px] sm:w-[168px] bg-white dark:bg-gold-500 text-brand-700 dark:text-ink-900 font-bold px-4 py-1.5 sm:px-6 sm:py-2 rounded-full hover:bg-brand-50 dark:hover:bg-gold-400 transition shadow-lg shadow-black/10 text-xs sm:text-base whitespace-nowrap"
                            >
                            ...
                            <button
                                ...
                                className="inline-flex items-center justify-center gap-1.5 sm:gap-2 w-[130px] sm:w-[168px] bg-white/10 text-white font-semibold px-4 py-1.5 sm:px-6 sm:py-2 rounded-full border border-white/30 hover:bg-white/20 transition backdrop-blur text-xs sm:text-base whitespace-nowrap"
                            >
                                {browseDisplay}
                            </button>
