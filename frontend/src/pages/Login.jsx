            ...
            <div className="min-h-[calc(100vh-64px)] grid lg:grid-cols-2">
                ...
                <div className="flex items-center justify-center px-4 py-16 bg-slate-50 dark:bg-ink-900">
                    <div className="w-full max-w-sm">
                        <h1 className="text-2xl font-extrabold text-slate-900 dark:text-gold-50">Welcome back</h1>
                        <p className="text-sm text-slate-500 dark:text-gold-200/50 mt-1">Log in with your university email.</p>
