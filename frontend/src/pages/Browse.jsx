        ...
        <div>
            ...
            <section className="sticky top-16 z-30 relative overflow-hidden bg-gradient-to-br from-brand-900 via-brand-700 to-accent-600 dark:from-ink-900 dark:via-ink-800 dark:to-gold-900">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                    <div className="flex items-center justify-between flex-wrap gap-3">
                        ...
                        <div className="flex items-center gap-2 sm:gap-3 flex-wrap">
                            <select
                                ...
                                className="bg-white/10 text-white text-xs sm:text-sm font-semibold px-3 py-1.5 sm:px-4 sm:py-2 rounded-full border border-white/30 backdrop-blur focus:outline-none cursor-pointer"
                            >
                            ...
                            <button
                                ...
                                className={`inline-flex items-center gap-1 sm:gap-1.5 text-xs sm:text-sm font-semibold px-3 py-1.5 sm:px-4 sm:py-2 rounded-full border backdrop-blur transition ${
                                    verifiedOnly
                    ...
                    {/* PRICE FILTER ROW */}
                    <div className="flex items-center gap-1.5 sm:gap-2 flex-wrap mt-5">
                        {PRICE_RANGES.map((r) => (
                            <button
                                key={r.label}
                                onClick={() => setPriceRange(priceRange?.label === r.label ? null : r)}
                                className={`text-xs sm:text-sm font-semibold px-2.5 py-1 sm:px-3.5 sm:py-1.5 rounded-full border backdrop-blur transition ${
