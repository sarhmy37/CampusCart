            ...
            <div className="min-h-[calc(100vh-64px)] grid lg:grid-cols-2">
                ...
                <div className="flex items-center justify-center px-4 py-16 bg-slate-50 dark:bg-ink-900">
                    <div className="w-full max-w-sm">
                        <h1 className="text-2xl font-extrabold text-slate-900 dark:text-gold-50">Create your account</h1>
                        <p className="text-sm text-slate-500 dark:text-gold-200/50 mt-1">It only takes a minute.</p>

                        {/* ACCOUNT TYPE TOGGLE */}
                        <div className="mt-5 grid grid-cols-2 gap-2 bg-slate-100 dark:bg-ink-800 p-1 rounded-xl">
                            <button
                                type="button"
                                onClick={() => setAccountType('buyer')}
                                className={`flex items-center justify-center gap-1.5 py-2.5 rounded-lg text-sm font-semibold transition ${
                                    accountType === 'buyer'
                                        ? 'bg-white dark:bg-ink-700 text-brand-700 dark:text-gold-400 shadow-sm'
                                ...
                                <div className="flex mt-1 gap-1.5">
                                    <div className="relative w-32">
                                        <select
                                            ...
                                            className="w-full pl-2 pr-6 py-2.5 rounded-xl border border-slate-200 dark:border-ink-600 focus:border-brand-500 dark:focus:border-gold-500 focus:ring-2 focus:ring-brand-100 dark:focus:ring-gold-900 focus:outline-none text-sm bg-white dark:bg-ink-800 text-slate-900 dark:text-gold-50 appearance-none transition"
                                        >
                                            {COUNTRY_CODES.map((c) => (
