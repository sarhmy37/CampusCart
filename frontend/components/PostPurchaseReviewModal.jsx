            ...
            <div className="relative bg-white dark:bg-ink-800 rounded-2xl shadow-2xl w-full max-w-sm p-6">
                ...
                <div className="flex items-center gap-3">
                    {currentPrompt.seller_avatar ? (
                        ...
                        <div className="w-11 h-11 rounded-full bg-brand-50 dark:bg-gold-900 text-brand-600 dark:text-gold-400 flex items-center justify-center font-bold">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-slate-500 dark:text-gold-200/50">Rate your purchase from {currentPrompt.seller_name}</p>
                    </div>
                </div>
                ...
                <textarea
                    ...
                    rows={3}
                    disabled={submitting}
                    className="w-full mt-4 px-3 py-2 rounded-lg border border-slate-200 dark:border-ink-600 dark:bg-ink-700 dark:text-gold-50 dark:placeholder-gold-300/30 focus:border-brand-500 dark:focus:border-gold-500 focus:outline-none text-sm transition resize-none disabled:opacity-60"
                />
